...
namespace NAudio.Wave
{
    ...
    public class WaveInStream : WaveStream
    {
        ...
        public WaveInStream(int deviceNumber, WaveFormat desiredFormat, System.Windows.Forms.Control callbackWindow, int bufferSize, int numBuffers)
        {
        ...
        public WaveInStream(int deviceNumber, WaveFormat desiredFormat, System.Windows.Forms.Control callbackWindow)
            : this( deviceNumber, desiredFormat, callbackWindow,  desiredFormat.AverageBytesPerSecond / 10, 3)
        {
        }
